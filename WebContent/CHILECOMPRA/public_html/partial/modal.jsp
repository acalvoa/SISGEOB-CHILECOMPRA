			...
			<div class="content">
				...
				<div class="ayuda modal-ini-content">
					<div class="tabs">
						...
						<div class="manual">
							<div class="item">
								<div class="titulo">Manual GEO-CGR</div>
								<div class="file"><a href="CHILECOMPRA/public_html/download/Manual-GEOCGR.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></div>
							</div>
							<div class="item">
					...
					<div class="tcontent">
						<div class="tabcontent tab1">
							...
							<div class="content" style="display:block;">
								...
								<p>GEO-CGR es un sistema inform&aacute;tico que permitir&aacute; articular, almacenar, publicar y consultar informaci&oacute;n georreferenciada de la inversi&oacute;n de recursos en obras p&uacute;blicas, con el objetivo de promover el control ciudadano mediante la entrega de instrumentos para el an&aacute;lisis y monitoreo de informaci&oacute;n confiable, oportuna y con contexto territorial, &uacute;til para la autoridad, entregando la posibilidad de realizar denuncias y sugerencias de fiscalizaci&oacute;n, facilitando su participaci&oacute;n activa en el control del uso de los recursos p&uacute;blicos.</p>
								<p>Dicho portal puede ser visitado siguiendo el siguiente link: <a href="http://www.contraloria.cl/geocgrappcgr/GEOCGR/index.jsp" target=_blank>www.contraloria.cl/geocgr</a>.</p>
								...
								<h4>&iquest;Qu&eacute; obras se registran en el formulario GEO-CGR?</h4>
								<p>En el portal GEO-CGR se registran los datos de los contratos de obras p&uacute;blicas que  ejecutan o financian las entidades p&uacute;blicas y que de acuerdo con la ley N&deg; 19.886 les asiste el deber de publicarlos en el portal Mercado P&uacute;blico (Sistema Nacional de Compras P&uacute;blicas), a partir de Enero de 2015. Adem&aacute;s de los contratos de obras que han sido objeto de toma de raz&oacute;n por parte de Contralor&iacute;a en el periodo 2013-2014. El portal GEO-CGR no publica informaci&oacute;n de obras ejecutadas por empresas del Estado ni de las que cuentan con participaci&oacute;n de estas.</p>
								<h4>&iquest;Por qu&eacute; se agreg&oacute; este formulario GEO-CGR en el sistema MercadoP&uacute;blico.cl?</h4>
						...
						<div class="tabcontent tab2">
							...
							<div class="content">
								<h4>&iquest;Qui&eacute;nes deben registrar en este formulario?</h4>
								<p>Deben registrar en el formulario GEO-CGR, todas las Entidades P&uacute;blicas que efect&uacute;en sus licitaciones en el sistema www.mercadopublico.cl y que hayan marcado la opci&oacute;n "Licitaci&oacute;n de Contrato de Obra" siguiendo para ello la definici&oacute;n de Contrato de Obra P&uacute;blica establecida por Contralor&iacute;a General de la Rep&uacute;blica.</p>
								...
								<p><a href="http://formacion.chilecompra.cl/Default.aspx?option=com_documents&task=download&id=2I1c0elbVe0%3d" target=_blank>http://formacion.chilecompra.cl/Default.aspx?option=com_documents&task=download&id=2I1c0elbVe0%3d</a></p>
								<h4>Una vez que marque mi licitaci&oacute;n como contrato de obra &iquest;Es obligatorio registrar el formulario GEO-CGR?</h4>
								<p>La opci&oacute;n de Licitaci&oacute;n de Contrato de Obra o marca de obra est&aacute; disponible para ser seleccionada en la etapa de creaci&oacute;n de licitaci&oacute;n, dentro del sistema www.mercadopublico.cl.</p>
								<p>Para m&aacute;s detalles respecto de la visualizaci&oacute;n de esta opci&oacute;n, puede consultar el siguiente v&iacute;nculo que contiene el manual elaborado por la Direcci&oacute;n ChileCompra:</p>
								<p><a href="http://formacion.chilecompra.cl/Default.aspx?option=com_documents&task=download&id=2I1c0elbVe0%3d" target=_blank>http://formacion.chilecompra.cl/Default.aspx?option=com_documents&task=download&id=2I1c0elbVe0%3d</a></p>
								<h4>&iquest;En qu&eacute; momento del proceso de licitaci&oacute;n se habilita la posibilidad de registrar en el formulario GEO-CGR?</h4>
								<p>El acceso al formulario GEO-CGR se produce  en el sistema www.mercadopublico.cl, durante la adjudicaci&oacute;n de la licitaci&oacute;n, dentro del paso denominado Acta de Adjudicaci&oacute;n, esto es antes de la validaci&oacute;n y confirmaci&oacute;n de dicho proceso.</p>
								<p>Para m&aacute;s detalles respecto de la visualizaci&oacute;n de esta opci&oacute;n, puede consultar el siguiente v&iacute;nculo que contiene el manual elaborado por la Direcci&oacute;n ChileCompra:</p>
								<p><a href="http://formacion.chilecompra.cl/Default.aspx?option=com_documents&task=download&id=2I1c0elbVe0%3d" target=_blank>http://formacion.chilecompra.cl/Default.aspx?option=com_documents&task=download&id=2I1c0elbVe0%3d</a></p>
								<h4>&iquest;C&oacute;mo accedo al formulario GEO-CGR?</h4>
								<p>El acceso al formulario GEO-CGR se efect&uacute;a mediante un bot&oacute;n denominado &quot;Registrar en GEO-CGR&quot;, ubicado en la parte inferior del paso Acta de Adjudicaci&oacute;n, contenido en la etapa de Adjudicaci&oacute;n de la Licitaci&oacute;n.</p>
							</div>
						</div> 
						<div class="tabcontent tab3">
							<div class="titulo" ng-click="m.tcontent($event)">C&oacute;mo y qu&eacute; se registra</div>
							<div class="content">
								<h4>&iquest;Qu&eacute; datos debo ingresar al formulario GEO-CGR?</h4>
								<p>El Formulario GEO-CGR contempla un mapa y un panel de registro con 3 pesta&ntilde;as. En t&eacute;rminos generales la primera de ellas sirve de ayuda para completar los datos, la segunda pesta&ntilde;a tiene por objeto captar la localizaci&oacute;n de la obra y en la tercera pesta&ntilde;a se ingresan 11 datos vinculados con el contrato de obra propiamente tal (Modalidad de Contrataci&oacute;n, Tipo de Financiamiento, Servicio Contratante, Servicio Mandante, C&oacute;digo BIP, C&oacute;digo INI, C&oacute;digo, Clasificaci&oacute;n de la Obra, Comuna, Inicio Estimado y T&eacute;rmino Estimado).</p>
								<h4>&iquest;C&oacute;mo se completa el formulario GEO-CGR?</h4>
								<p>Este formulario no posee una estructura lineal de llenado, por lo que se puede iniciar el registro de datos a conveniencia del usuario. En la pesta&ntilde;a inicial, se mostrar&aacute; un resumen de completitud de los datos. Una vez que se hayan ingresado todos los datos obligatorios se podr&aacute; finalizar el registro con &eacute;xito.</p>
								<h4>&iquest;Cu&aacute;les datos son obligatorios que debo ingresar en el formulario GEO-CGR?</h4>
								...
								<p>1. Dibujar en Mapa. Esta alternativa permitir&aacute; dibujar directamente sobre el mapa, siguiendo una serie de pasos hasta obtener la Localizaci&oacute;n Geogr&aacute;fica definitiva, seg&uacute;n lo dispuesto en el manual adjunto en esta misma secci&oacute;n de ayuda.</p>
								<p>2. Adjuntar Archivo KML. La segunda alternativa, disponible desde la pesta&ntilde;a Inicio, permitir&aacute; subir directamente el dato de localizaci&oacute;n para aquellos casos en que ya se haya confeccionado un archivo espec&iacute;fico, construido en base a las instrucciones dispuestas en este manual.</p>
								<p>3. Sin Ubicaci&oacute;n Definida. Esta opci&oacute;n se dispone para aquellas obras que poseen una ubicaci&oacute;n imprecisa, variable o indeterminada. Ser&aacute; accesible desde la pesta&ntilde;a Inicio mediante un bot&oacute;n que estar&aacute; directamente vinculado con el campo Comuna de la pesta&ntilde;a Formulario.</p>
								<h4>&iquest;Es posible modificar el registro del formulario una vez que ya ha sido enviado al sistema?</h4>
								<p>S&oacute;lo se podr&aacute; modificar el registro de GEO-CGR para aquellos casos en que no se valide ni confirme la adjudicaci&oacute;n en el sistema Mercado P&uacute;blico. Para aquellas situaciones se volver&aacute; a habilitar el bot&oacute;n de acceso a GEO-CGR pudiendo de ese modo efectuar las modificaciones que sean necesarias.</p>
							</div>
						</div>
						<div class="tabcontent tab4">
							...
							<div class="content">
								...
								<p>Se refiere al evento de ejecutar una obra determinada o parte de ella, en una localizaci&oacute;n espec&iacute;fica, cuya disposici&oacute;n para efectos del sistema GEO-CGR, ser&aacute; exclusivamente de car&aacute;cter puntual o lineal.</p>
								...
								<p><a href="https://www.youtube.com/watch?v=aWtqjt8Q-uk">VER VIDEO TUTORIAL.</a> El archivo KML puede crearse directamente en el programa Google Earth siguiendo las instrucciones contenidas en el Manual de Usuario para Entidades P&uacute;blicas. En caso de que el archivo se genere a partir de un software SIG, este debe tener las siguientes caracter&iacute;sticas:</p>
								<p>1. El archivo KML debe incluir campo ID_MP en el que se indique el c&oacute;digo de licitaci&oacute;n de Mercado P&uacute;blico.</p>
								<p>2. Debe estar proyectado en coordenadas geogr&aacute;ficas.</p>
								<p>3. Debe estar referido al sistema WGS84.</p>
								<p>4. Luego, se debe incluir campo LIN_ADJ en el que se indique para cada intervenci&oacute;n la numeraci&oacute;n de la l&iacute;nea de adjudicaci&oacute;n respectiva.</p>
				...
				<div class="contacto modal-ini-content">
					...
					<br>
					En caso de dudas o consultas, puede contactarse a trav&eacute;s del siguiente correo electr&oacute;nico: <a href="mailto:geocgr@contraloria.cl">geocgr@contraloria.cl</a>  
				</div>
			</div>
		</div>
		<div class="footer">
